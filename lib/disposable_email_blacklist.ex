defmodule DisposableEmailBlacklist do
  @moduledoc """
  ...
  @doc """
  Check if given email is included in black listed emails
  ...
  """
  def valid?(email, custom_list \\ []) do
    [_, domain] = String.split(email, "@")

    !Enum.member?(@blacklisted_emails ++ custom_list, domain)
  end
end
